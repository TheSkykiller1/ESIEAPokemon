	...
	void CWorld::read_config_object()
	{
		...
		if (File.is_open())
		{
			while (getline(File, row))
			{
				...
				{
					std::string name, genre, etat="Null";
					int id;
					...
					//std::cout << "Info id: " << id << " genre:" << genre << " name:" << name << " speed:" << speed << " attack:" << attack << " defense:" << defense << " hp:" << hp << " etat: "<< etat << "\n";
					/*if (genre == "Potion")
					{
						...
						Potions.push_back(potion);//On stoque la variable
					}
					if (genre == "Drug")
					{
